...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Ex07 ButtonDeco'),
    );
  }
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          Text(
            name, // 문자열 표현식만 있는 경우 $를 사용하지 않는다.
            // 자동으로 지정되는 영문과 한글의 글자 높이가 달라서
          ...
          TextButton.icon(
            ...
            label: const Text('TextButton + icon',
              ...
              style: TextButton.styleFrom( // 클릭했을시 나오는 색깔을 지정할 수 있다.
