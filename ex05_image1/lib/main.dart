...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Ex05 Image1'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void getWindowSize() { // print로 출력한 결과는 디버그 콘솔에서확인
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // 해당 배율에 이미지가 있으므로 해당 배율의 분홍 이미지 사용
      ...
      // Image.asset의 크기가 지정된 것이지 내부의 이미지크기가 지정된
      // 것이 아님
       Image.asset(
        'assets/images/300x300b.png',
        // fit: BoxFit.fill,
        width: 100, // 액자의 크기를 지정해 주는것. 이렇게 지정해서 사용하는
                    // 것이 좋다.
      ),
