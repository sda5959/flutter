...
void main(){
  ...
  myReq1.then((data){ // print들이 먼저 실행 됨
    // 결과가 도착하면 나중에 출력한다.
  ...
  // 내부 클래스에 사용할 변수 생성.
  int nCount = 10; // 다음은 이너 클래스 (내부 클래스)이므로 이변수 사용가능
  ...
  // Future 객체를 통해서 즉시 실행
  print("myRequest2 시작3");
  myRequest2.then((data){
    // 미래에 결과가 도착하면 출력
    print('myRequest2 작업3 : $data'); // 나중에세번 쨰 출력. 마지막에 출력
  }, onError: (e){
    print(e);
  });
  print("myRequest2 끝3");
