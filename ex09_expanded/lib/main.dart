...
class _MyHomePageState extends State<MyHomePage> {
            ...
            children:<Widget>[
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    // 수평방향으로 간격설정, 사이간격 줄떄 많이 사용한다.
                    const SizedBox(width: 20),
                    IconButton(
                      icon: const Icon(Icons.download_sharp),
                      tooltip: "이미지 아래로 이동",
                      iconSize: 50.0,
                      onPressed: () => _onClick2(), //람다형식
                      ),
                  ],
                ),
              ),
              Expanded(
                ...
                child: Container(
                  ...
                  color: Colors.cyan,
                  alignment: Alignment.topLeft,
                  child: Image.asset( // image asset하려면 재실행 할것
                    _image2,
                    alignment: Alignment.topLeft,
  ...
  void _onClick1() {
    /*
      상태변경을 위해 사용하는 메서드로 특정 변수를 변경시키게 되면
      화면의 렌더링이 다시 진행되면서 변경된 화면을 볼 수 있게된다.
    */
    setState(() {
